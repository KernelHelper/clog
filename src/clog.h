...
struct timezone#ifndef __CLOG_H__#ifndef __CLOG_H__
#define __CLOG_H__
...
#if defined(_MSC_VER) || defined(_MSC_EXTENSIONS)
#define __CLOG_GLOBAL_MACROS_DEFINE__ CRITICAL_SECTION log_locker = { 0 };struct log_set* p_log_set = 0;
...
#define log_exit_lock()		DeleteCriticalSection(&log_locker)
#else
#define __CLOG_GLOBAL_MACROS_DEFINE__	pthread_mutex_t log_locker;struct log_set* p_log_set = 0;
